                        ...
                        <div v-else v-for="item in history" :key="item.timestamp"
                            ...
                            <div class="flex items-center gap-3 flex-1 min-w-0">
                                ...
                                <div class="flex flex-col min-w-0 flex-1">
                                    ...
                                    <div class="flex items-center gap-2 text-xs text-gray-400">
                                        ...
                                        <span>•</span>
                                        <span>{{ item.modType? modTypeMap[item.modType] || item.modType: "Unknown" }}</span>
                                        <span>•</span>
                            ...
                            <div class="flex items-center gap-2 flex-shrink-0">
                                ...
                                <button @click="handleSelect(item)"
                                    class="cursor-pointer text-sm bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-500 transition">
                                    Load
                                </button>
                            </div>
                        </div>
